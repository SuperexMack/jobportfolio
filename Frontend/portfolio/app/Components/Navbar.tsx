        ...
        <div className="w-full z-50 fixed top-0 h-[80px] bg-black p-3 flex justify-center items-center space-x-6 border-b border-t border-gray-900">
            ...
            <Link href={"/"}><h1 className="font-bold text-[25px] text-white">Portfolio</h1></Link>
             ...
             {clicked?(
                ...
                <Link target="_blank" href={"https://drive.google.com/drive/folders/1h-g1fopBtaQlBDfR4F7-PKYyJ_NIRdPA?usp=sharing"}><h1 className="hover:text-slate-400 md:flex font-bold text-white">Resume</h1></Link>
                ...
                <Link target="_blank" href={"https://drive.google.com/drive/folders/1h-g1fopBtaQlBDfR4F7-PKYyJ_NIRdPA?usp=sharing"}><h1 className="hover:text-slate-400 md:flex hidden font-bold text-white">Resume</h1></Link>
